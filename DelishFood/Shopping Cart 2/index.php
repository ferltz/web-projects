...
<html>
	...
	<body>
		...
		<div class="container">
			...
			<br /><br />
			<?php
				$query = "SELECT * FROM tbl_product1 ORDER BY id ASC"; //querying the database
			...
			<div class="col-md-4">
				<form method="post" action="index.php?action=add&id=<?php echo $row["id"]; ?>">
					<div style="border:1px solid #333; background-color:#f1f1f1; border-radius:5px; padding:16px; width:25%;" align="center">
			...
			<div class="table-responsive">
				<table class="table table-bordered">
					...
					<?php
						$cookie_name = "Total";
						setcookie($cookie_name, $total, time() + (86400 * 30), "/"); // 86400 = 1 day
					}
					?>
			...
			<input type="button" name="submit" value= "Submit" onclick="window.open ('nextpage.php','_self',false)" />
